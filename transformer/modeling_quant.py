...
from .utils_quant import QuantizeEmbedding, QuantizeLinear, SymQuantizer, BinaryQuantizer, ZMeanBinaryQuantizer
...
class BertEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        self.word_embeddings = QuantizeEmbedding(config.vocab_size,
                                                 ...
                                                 config=config,
                                                 type="word_embd")
        self.position_embeddings = QuantizeEmbedding(
            config.max_position_embeddings,
            config.hidden_size,
            padding_idx=0,
            config=config,
            type="pos_embd")
        self.token_type_embeddings = QuantizeEmbedding(config.type_vocab_size,
                                                       config.hidden_size,
                                                       padding_idx=0,
                                                       config=config,
                                                       type="token_type_embd")
